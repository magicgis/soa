  ...
  <div class="Content fontText">
    ...
    <div class="submenu">
      <div align="right" style="padding-right: 30px; height: 0px;">
        <a href="${ctxPath}weights/add">新增权重调节</a>
      </div>
    </div>
    <%@ include file="/WEB-INF/views/weights/control/listControl.jsp" %>
  </div>
  <div class="clearer"></div>
  <br/>
</div>
<script type="text/javascript">
  ...
  function query() {
    window.location.href = GV.ctxPath + "weights?" + $("#queryForm").serialize();
  }
</script>
</body>
</html>
