  ...
  <div class="Content fontText">
        ...
        <div class="search">
          ...
          <div class="search_con">
            <ul class="fix">
              ...
              <%--</li>--%>
              <li>
                <label class="text_tit">类型：</label>
                <select id="allow" name="allow" class="input_text">
                  <option selected="selected" value="">全部</option>
            ...
            <div class="btn">
              <input id="Submit" type="button" class="btn_sure fw" value="查 询"/>
    ...
    <div class="submenu">
      <div align="right" style="padding-right: 30px; height: 0px;">
        <a href="${ctxPath}accesses/add">新增访问控制</a>
      </div>
    </div>
    <%@ include file="/WEB-INF/views/accesses/control/listControl.jsp" %>
  </div>
  <div class="clearer"></div>
  <br/>
</div>
  ...
  $(function () {
    ...
    $("#Submit").click(function () {
      ...
      if (address != "" && address.indexOf(':') === -1) {
        MessageBoxExt.alert("暂时只支持 ip:port 形式的查询");
        return false;
      } else {
        $("#queryForm").submit();
      }
